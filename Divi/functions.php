...
/*function the_breadcrumb($testing,$categories,$group,$link,$subCategories,$sublink) {
	if (!is_home()) {
		echo '<a href="';
		...
		echo "</a> » ";
		if($testing){?>
			<a href="<?php echo network_home_url();?>/our-product">
			<?php
            echo $testing."</a> » ";
		...
		if($group && !$subCategories){
			?>
			<a href="<?php echo network_home_url();?>/categories/?sh=<?php echo $link;?>">
			<?php	echo $categories."</a> » ";
			echo $group;
		}
		if($subCategories){
			?>
			<a href="<?php echo network_home_url();?>/subcategories/?sh=<?php echo $link;?>">
			<?php	echo $group."</a> » ";?>
				<a href="<?php echo network_home_url();?>/subcategories/?sh=<?php echo $sublink;?>">
		<?php	echo $subCategories."</a> » ";
		}
...
function the_breadcrumb($product,$categories,$group,$catLink,$groupLink,$subDescription,$subLink) {
if(!is_home()) {
		echo '<a href="';
		echo get_option('home');
		echo '">Home';
	...
	if($product){
   		if($product == "Our Brands"){?>
          		<a href="<?php echo network_home_url();?>/brand/">
	<?php }else{?>
				<a href="<?php echo network_home_url();?>/our-product">
	<?php }
    	   echo $product."</a> »";
   }
   if($categories && !$catLink){
	   
	   /*if($group){
		  echo "<a href='/categories/?sh=".$catLink."'>".$categories."</a> »".$group; 
	   }
	   else{*/
		   echo $categories;
	  // }
   ...
   if($categories && $catLink && $group && !$groupLink && !$subLink){
	   		  echo "<a href='/categories/?sh=".$catLink."'>".$categories."</a> » ".$group; 

   }
   if($groupLink && $group && $subDescription && !$subLink){
	    echo "<a href='/categories/?sh=".$catLink."'>".$categories."</a> » ";
		echo "<a href='/subcategories/?sh=".$groupLink."'>".$group."</a> » ".$subDescription;
   }
 
   if($groupLink && $group && !$subDescription && !$subLink){
	   	   echo "<a href='/categories/?sh=".$catLink."'>".$categories."</a> » ";
   	   	   echo "<a href='/productlist/?PO=".$groupLink."'>".$group."</a> » ";

   }
   
   if($subLink){
	   echo "<a href='/categories/?sh=".$catLink."'>".$categories."</a> » ";
		echo "<a href='/subcategories/?sh=".$groupLink."'>".$group."</a> » ";
		echo "<a href='/productlist/?PO=".$subLink."'>".$subDescription."</a> » ";
   }
